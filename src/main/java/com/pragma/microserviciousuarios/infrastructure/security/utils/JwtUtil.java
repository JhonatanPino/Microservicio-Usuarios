package com.pragma.microserviciousuarios.infrastructure.security.utils;

import com.pragma.microserviciousuarios.domain.models.UserModel;
import com.pragma.microserviciousuarios.infrastructure.security.config.JwtConfig;
import com.pragma.microserviciousuarios.infrastructure.security.model.JwtClaimsModel;
...
public class JwtUtil {
    ...
    public String generateToken(UserModel user) {
        JwtClaimsModel claims = new JwtClaimsModel(user.getEmail(), user.getRole().getName(), user.getId());
        return Jwts.builder()
